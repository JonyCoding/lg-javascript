...
},{"./vnode":"node_modules/snabbdom/build/vnode.js","./is":"node_modules/snabbdom/build/is.js"}],"src/02-basicusage.js":[function(require,module,exports) {
"use strict";
...
var vnode = (0, _h.h)('div.#container', [(0, _h.h)('h1', 'hello stobbdom'), (0, _h.h)('p', '这是P标签')]);
var app = document.querySelector('#app');
var oldVnode = patch(app, vnode);
setTimeout(function () {
  vnode = (0, _h.h)('div#container', [(0, _h.h)('h1', 'hello world'), (0, _h.h)('p', 'Hello P')]);
  oldVnode = patch(oldVnode, vnode); // 两秒后清楚内容
...
},{"snabbdom/build/init":"node_modules/snabbdom/build/init.js","snabbdom/build/h":"node_modules/snabbdom/build/h.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3138" + '/');
