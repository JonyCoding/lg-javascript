...
},{"./vnode":"node_modules/snabbdom/build/vnode.js","./is":"node_modules/snabbdom/build/is.js"}],"src/01-basicusage.js":[function(require,module,exports) {
"use strict";
...
var patch = (0, _init.init)([]); // 第一个参数 ： 标签加选择器
// 第二个参数 ： 标签中文本内容

var vnode = (0, _h.h)('div#container.cls', 'hello world');
var app = document.querySelector('#app'); // 第一个参数：旧的vnode：可以是dom元素
// 第二个参数：新的vNode
// 返回一个VNode

var oldVnode = patch(app, vnode);
vnode = (0, _h.h)('div#container.xxx', 'hello Snobbdom');
